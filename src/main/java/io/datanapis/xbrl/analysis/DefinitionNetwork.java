...
public class DefinitionNetwork extends DefinitionTaxonomy {
    public DefinitionNetwork(XbrlInstance instance) {
        super(instance.getTaxonomy());
    }

    public DefinitionNetwork(DiscoverableTaxonomySet dts) {
        super(dts);
    }
}
